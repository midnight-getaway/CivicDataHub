  ...
  <main class="about-layout">
    <div class="container">
      ...
      <section class="about-intro">
        <h1>About Us</h1>
        <hr>
        <p>Civic Data Hub is a web-based platform designed to make New York State data more accessible,
          ...
          support evidence-based planning and policy decisions.<br><br>This project was built by a group of
      ...
      <section class="graphic-placeholder" role="img" style="margin: 5px; margin-bottom: 2rem;">
        image placeholder
      </section>
      ...
      <section class="about-row">
        ...
        <div class="about-column">
          ...
          <p>I am a student at UAlbany studying Informatics with a concentration in UX/UI, and I work
            ...
            nonprofit sector. My contributions include developing the user needs assessment, style guide, and
            wireframes, leading the database design and data architecture, and contributing to the overall
            visual design and layout of the site. CINF 362 gave me the opportunity to formalize skills I had
            been building in practice — deepening my understanding of PHP, MySQL, and front-end development
            and applying them to work I genuinely care about. Building the Civic Data Hub has been a chance
            to put that all together — because communities thrive when their leaders have access to clear,
            credible data and the tools to act on it.</p>
        </div>
      </section>
